...
def read_model(point_cloud_path, read_face = False, read_color = False, scale = 1.0):
    x = []
    y = []
    z = []
    rgb = []
    ...
    return np.array([x, y, z]), face_index, np.array(rgb).T
